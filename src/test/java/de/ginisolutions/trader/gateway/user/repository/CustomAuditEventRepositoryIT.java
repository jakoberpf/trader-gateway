...
import de.ginisolutions.trader.gateway.user.config.audit.AuditEventConverter;
import de.ginisolutions.trader.gateway.user.domain.PersistentAuditEvent;
...
import static de.ginisolutions.trader.gateway.user.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
