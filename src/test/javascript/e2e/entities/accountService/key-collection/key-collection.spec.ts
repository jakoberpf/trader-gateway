...
describe('KeyCollection e2e test', () => {
  ...
  it('should load KeyCollections', async () => {
    ...
    expect(await keyCollectionComponentsPage.getTitle()).to.eq('userGatewayApp.accountServiceKeyCollection.home.title');
    await browser.wait(
  ...
  it('should load create KeyCollection page', async () => {
    ...
    expect(await keyCollectionUpdatePage.getPageTitle()).to.eq('userGatewayApp.accountServiceKeyCollection.home.createOrEditLabel');
  ...
  it('should delete last KeyCollection', async () => {
    ...
    expect(await keyCollectionDeleteDialog.getDialogTitle()).to.eq('userGatewayApp.accountServiceKeyCollection.delete.question');
