...
describe('KeySet e2e test', () => {
  ...
  it('should load KeySets', async () => {
    ...
    expect(await keySetComponentsPage.getTitle()).to.eq('userGatewayApp.userGatewayKeySet.home.title');
  ...
  it('should load create KeySet page', async () => {
    ...
    expect(await keySetUpdatePage.getPageTitle()).to.eq('userGatewayApp.userGatewayKeySet.home.createOrEditLabel');
  ...
  it('should delete last KeySet', async () => {
    ...
    expect(await keySetDeleteDialog.getDialogTitle()).to.eq('userGatewayApp.userGatewayKeySet.delete.question');
