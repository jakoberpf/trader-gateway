...
describe('KeySet e2e test', () => {
  ...
  it('should load KeySets', async () => {
    ...
    expect(await keySetComponentsPage.getTitle()).to.eq('traderGatewayApp.userGatewayKeySet.home.title');
  ...
  it('should load create KeySet page', async () => {
    ...
    expect(await keySetUpdatePage.getPageTitle()).to.eq('traderGatewayApp.userGatewayKeySet.home.createOrEditLabel');
  ...
  it('should create and save KeySets', async () => {
    ...
    await promise.all([
      keySetUpdatePage.setOwnerInput('owner'),
    ...
    expect(await keySetUpdatePage.getOwnerInput()).to.eq('owner', 'Expected Owner value to be equals to owner');
  ...
  it('should delete last KeySet', async () => {
    ...
    expect(await keySetDeleteDialog.getDialogTitle()).to.eq('traderGatewayApp.userGatewayKeySet.delete.question');
