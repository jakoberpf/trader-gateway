...
describe('UserAccount e2e test', () => {
  ...
  it('should load UserAccounts', async () => {
    ...
    expect(await userAccountComponentsPage.getTitle()).to.eq('traderGatewayApp.userGatewayUserAccount.home.title');
    await browser.wait(
  ...
  it('should load create UserAccount page', async () => {
    ...
    expect(await userAccountUpdatePage.getPageTitle()).to.eq('traderGatewayApp.userGatewayUserAccount.home.createOrEditLabel');
  ...
  it('should delete last UserAccount', async () => {
    ...
    expect(await userAccountDeleteDialog.getDialogTitle()).to.eq('traderGatewayApp.userGatewayUserAccount.delete.question');
